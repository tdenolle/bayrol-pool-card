...
`;function _t(t){return t.replace(/[\W_]/g,"").toLowerCase()}function mt(t,e,i,s="sensor"){const o=function(t,e,i="sensor"){return`${i}.${_t("Bayrol")}_${_t(t)}_${e}`}(e,i,s);if(t[o])return o;const r=_t(e);for(const e of Object.keys(t))if(e.startsWith(`${s}.`)&&e.includes(r)&&e.endsWith(`_${i}`))return e}function vt(t){if(void 0===t||"unknown"===t||"unavailable"===t)return null;const e=parseFloat(t);return isNaN(e)?null:e}function yt(t,e,i,s,o){return t>=s&&t<=o?"var(--success-color, #4caf50)":t>=e&&t<=i?"var(--warning-color, #ff9800)":"var(--error-color, #f44336)"}function $t(t){return yt(t,6.8,7.8,7,7.4)}function bt(t){return yt(t,550,900,650,750)}const xt=[{key:"temperature",label:"Température",icon:"mdi:thermometer-water",unit:"°C"},{key:"ph",label:"pH",icon:"mdi:ph",unit:"pH",color_fn:$t},{key:"mv_se",label:"ORP",icon:"mdi:water-opacity",unit:"mV",color_fn:bt},{key:"salt",label:"Sel",icon:"mdi:shaker-outline",unit:"g/L"}],wt=[{key:"se_on_off",label:"Électrolyse",domain:"switch"},{key:"ph_on_off",label:"Régulation pH",domain:"switch"},{key:"mv_on_off",label:"Régulation ORP",domain:"switch"},{key:"se_activate_boost",label:"Boost",domain:"switch"},{key:"filtration_mode",label:"Filtration",domain:"select"}];let Ct=class extends at{setConfig(t){if(!t.device_serial)throw new Error("Configuration requise : 'device_serial'");this._config={show_equipment:!0,...t}}getCardSize(){return this._config?.show_equipment?5:3}_getEntity(t,e="sensor"){if(!this.hass||!this._config)return;const i=this._config.entities;if(i&&i[t])return this.hass.states[i[t]];const s=this._config.entity_prefix;if(s)return this.hass.states[`${e}.${s}_${t}`];const o=mt(this.hass.states,this._config.device_serial,t,e);return o?this.hass.states[o]:void 0}_isOnline(){const t=this._getEntity("status");return!!t&&"Online"===t.state}_renderMetric(t){const e=this._getEntity(t.key,t.domain||"sensor"),i=e?vt(e.state):null,s=null!==i,o=s?i.toString():"--",r=s&&t.color_fn?t.color_fn(i):"var(--pool-text)",n=e?.attributes.min,a=e?.attributes.max,l=void 0!==n&&void 0!==a?`${n} — ${a}`:"";return D`
    ...
    `}static getConfigElement(){return document.createElement("bayrol-pool-dashboard-editor")}static getStubConfig(){return{device_serial:"",show_equipment:!0}}};Ct.styles=ft,t([pt({attribute:!1})],Ct.prototype,"hass",void 0),t([ut()],Ct.prototype,"_config",void 0),Ct=t([ct("bayrol-pool-dashboard-card")],Ct);let At=class extends at{setConfig(t){this._config=t}_valueChanged(t){if(!this._config)return;const e=t.target,i=e.configValue,s="checkbox"===e.type?e.checked:e.value,o={...this._config,[i]:s};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o}}))}render(){return this._config?D`
    ...
    `:D``}};t([pt({attribute:!1})],At.prototype,"hass",void 0),t([ut()],At.prototype,"_config",void 0),At=t([ct("bayrol-pool-dashboard-editor")],At);const Et={"6h":6,"24h":24,"7d":168,"30d":720};let kt=class extends at{constructor(){super(...arguments),this._period="24h",this._history=[],this._loading=!1}setConfig(t){if(!t.device_serial||!t.entity_key)throw new Error("Configuration requise : 'device_serial' et 'entity_key'");this._config={hours_to_show:24,...t}}getCardSize(){return 4}connectedCallback(){super.connectedCallback(),this._fetchHistory(),this._fetchTimer=window.setInterval(()=>this._fetchHistory(),3e5)}disconnectedCallback(){super.disconnectedCallback(),this._fetchTimer&&clearInterval(this._fetchTimer)}_getEntityId(){if(!this._config||!this.hass)return"";if(this._config.entity_id)return this._config.entity_id;const t=this._config.entity_prefix,e=this._config.entity_domain||"sensor";return t?`${e}.${t}_${this._config.entity_key}`:mt(this.hass.states,this._config.device_serial,this._config.entity_key,e)||""}_getEntity(){if(!this.hass)return;const t=this._getEntityId();return t?this.hass.states[t]:void 0}async _fetchHistory(){if(!this.hass||!this._config)return;const t=this._getEntityId(),e=Et[this._period],i=new Date(Date.now()-36e5*e).toISOString();this._loading=!0;try{const e=`history/period/${i}?filter_entity_id=${t}&minimal_response&no_attributes`,s=await this.hass.callApi("GET",e);if(s&&s.length>0&&s[0]){const t=s[0];this._history=t.filter(t=>"unknown"!==t.state&&"unavailable"!==t.state).map(t=>({x:new Date(t.last_changed).getTime(),y:parseFloat(t.state)})).filter(t=>!isNaN(t.y))}else this._history=[]}catch(t){this._history=[]}this._loading=!1,this._renderChart()}_setPeriod(t){this._period=t,this._fetchHistory()}async _renderChart(){if(await this.updateComplete,this._canvas=this.shadowRoot?.querySelector("canvas"),!this._canvas||0===this._history.length)return;const t=this._config?.color||"var(--primary-color, #03a9f4)";window.Chart||await this._loadChartJs();const e=window.Chart;if(!e)return;const i=e;this._chart&&this._chart.destroy(),this._chart=new i(this._canvas,{type:"line",data:{datasets:[{data:this._history,borderColor:t,backgroundColor:`${t}22`,borderWidth:1.5,fill:!1,tension:0,stepped:"before",pointRadius:0,pointHitRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},zoom:{pan:{enabled:!0,mode:"x"},zoom:{wheel:{enabled:!0,modifierKey:void 0},pinch:{enabled:!0},mode:"x"}}},scales:{x:{type:"time",time:{tooltipFormat:"dd/MM HH:mm",displayFormats:{minute:"HH:mm",hour:"HH:mm",day:"dd/MM"}},grid:{display:!1},ticks:{maxTicksLimit:8,color:"#999"}},y:{grid:{color:"rgba(0,0,0,0.06)"},ticks:{color:"#999"}}}}}),this._canvas.addEventListener("dblclick",()=>{this._chart?.resetZoom()})}_loadChartJs(){return new Promise((t,e)=>{const i=document.createElement("script");i.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",i.onload=()=>{const i=document.createElement("script");i.src="https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns@3/dist/chartjs-adapter-date-fns.bundle.min.js",i.onload=()=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/chartjs-plugin-zoom@2/dist/chartjs-plugin-zoom.min.js",e.onload=()=>t(),e.onerror=()=>{t()},document.head.appendChild(e)},i.onerror=()=>e(new Error("Failed to load chart adapter")),document.head.appendChild(i)},i.onerror=()=>e(new Error("Failed to load Chart.js")),document.head.appendChild(i)})}render(){if(!this._config||!this.hass)return D`<ha-card><div>Chargement...</div></ha-card>`;const t=this._getEntity(),e=t?vt(t.state):null,i=this._config.title||this._config.entity_key,s=this._config.unit||t?.attributes.unit_of_measurement||"";let o="var(--pool-text)";null!==e&&("ph"===this._config.entity_key?o=$t(e):"mv_se"===this._config.entity_key&&(o=bt(e)));const r=this._history.length>0?Math.min(...this._history.map(t=>t.y)).toFixed(1):void 0,n=this._history.length>0?Math.max(...this._history.map(t=>t.y)).toFixed(1):void 0;return D`
      <ha-card>
        ...
        <div class="current-value">
          ...
          ${s?D`<span class="unit">${s}</span>`:F}
          ${void 0!==r&&void 0!==n?D`<span class="min-max">Min: ${r} — Max: ${n}</span>`:F}
        </div>

        ${this._history.length>0?D`<div class="chart-wrapper"><canvas></canvas></div>`:D`<div class="no-data">${this._loading?"Chargement...":"Aucune donnée"}</div>`}
      </ha-card>
    `}static getConfigElement(){return document.createElement("bayrol-pool-chart-editor")}static getStubConfig(){return{device_serial:"",entity_key:"temperature",hours_to_show:24}}};kt.styles=gt,t([pt({attribute:!1})],kt.prototype,"hass",void 0),t([ut()],kt.prototype,"_config",void 0),t([ut()],kt.prototype,"_period",void 0),t([ut()],kt.prototype,"_history",void 0),t([ut()],kt.prototype,"_loading",void 0),kt=t([ct("bayrol-pool-chart-card")],kt);let St=class extends at{setConfig(t){this._config=t}_valueChanged(t){if(!this._config)return;const e=t.target,i=e.configValue,s={...this._config,[i]:e.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:s}}))}render(){return this._config?D`
      <div style="padding: 16px;">
        <ha-textfield
          label="Titre (optionnel)"
          .value="${this._config.title||""}"
    ...
    `:D``}};t([pt({attribute:!1})],St.prototype,"hass",void 0),t([ut()],St.prototype,"_config",void 0),St=t([ct("bayrol-pool-chart-editor")],St);const Pt={"6h":6,"24h":24,"7d":168,"30d":720};let Ht=class extends at{constructor(){super(...arguments),this._period="24h",this._tempHistory=[],this._filtrationOffRanges=[],this._loading=!1}setConfig(t){if(!t.device_serial)throw new Error("Configuration requise : 'device_serial'");this._config=t}getCardSize(){return 4}connectedCallback(){super.connectedCallback(),this._fetchHistory(),this._fetchTimer=window.setInterval(()=>this._fetchHistory(),3e5)}disconnectedCallback(){super.disconnectedCallback(),this._fetchTimer&&clearInterval(this._fetchTimer)}_getEntityId(t,e="sensor"){if(!this._config||!this.hass)return"";const i=this._config.entity_prefix;return i?`${e}.${i}_${t}`:mt(this.hass.states,this._config.device_serial,t,e)||""}_getTempEntity(){if(!this.hass)return;const t=this._getEntityId("temperature");return t?this.hass.states[t]:void 0}async _fetchHistory(){if(!this.hass||!this._config)return;const t=this._getEntityId("temperature"),e=this._getEntityId("flow_in"),i=Pt[this._period],s=new Date(Date.now()-36e5*i).toISOString();this._loading=!0;const o=this.hass.callApi.bind(this.hass);try{const i=`history/period/${s}?filter_entity_id=${e?`${t},${e}`:t}&minimal_response&no_attributes`,r=await o("GET",i);if(r&&r.length>0){const t=r.find(t=>{const e=t;return e.length>0&&e[0].entity_id?.includes("temperature")});this._tempHistory=t?t.filter(t=>"unknown"!==t.state&&"unavailable"!==t.state).map(t=>({x:new Date(t.last_changed).getTime(),y:parseFloat(t.state)})).filter(t=>!isNaN(t.y)):[];const e=r.find(t=>{const e=t;return e.length>0&&e[0].entity_id?.includes("flow_in")});this._filtrationOffRanges=e?this._computeOffRanges(e):[]}}catch(t){this._tempHistory=[],this._filtrationOffRanges=[]}this._loading=!1,this._renderChart()}_computeOffRanges(t){const e=[];let i=null;const s=Date.now();for(const s of t){const t=new Date(s.last_changed).getTime(),o=s.state?.toLowerCase();"off"===o||"unavailable"===o||"unknown"===o?null===i&&(i=t):"on"===o&&null!==i&&(e.push({start:i,end:t}),i=null)}return null!==i&&e.push({start:i,end:s}),e}_setPeriod(t){this._period=t,this._fetchHistory()}async _renderChart(){if(await this.updateComplete,this._canvas=this.shadowRoot?.querySelector("canvas"),!this._canvas||0===this._tempHistory.length)return;const t=this._config?.color||"#03a9f4",e=this._config?.filtration_off_color||"rgba(244, 67, 54, 0.15)";window.Chart||await this._loadChartJs();const i=window.Chart;if(!i)return;const s=i;this._chart&&this._chart.destroy();const o={};this._filtrationOffRanges.forEach((t,i)=>{o[`offRange${i}`]={type:"box",xMin:t.start,xMax:t.end,backgroundColor:e,borderWidth:0,label:{display:!1}}});const r=window.ChartAnnotation;r&&s.register(r),this._chart=new s(this._canvas,{type:"line",data:{datasets:[{label:"Température",data:this._tempHistory,borderColor:t,backgroundColor:`${t}22`,borderWidth:1.5,fill:!1,tension:0,stepped:"before",pointRadius:0,pointHitRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{callbacks:{afterBody:t=>{if(!t.length)return"";const e=t[0].parsed.x,i=this._filtrationOffRanges.some(t=>e>=t.start&&e<=t.end);return i?"⚠ Filtration arrêtée":"✓ Filtration active"}}},annotation:{annotations:o},zoom:{pan:{enabled:!0,mode:"x"},zoom:{wheel:{enabled:!0,modifierKey:void 0},pinch:{enabled:!0},mode:"x"}}},scales:{x:{type:"time",time:{tooltipFormat:"dd/MM HH:mm",displayFormats:{minute:"HH:mm",hour:"HH:mm",day:"dd/MM"}},grid:{display:!1},ticks:{maxTicksLimit:8,color:"#999"}},y:{grid:{color:"rgba(0,0,0,0.06)"},ticks:{color:"#999",callback:t=>`${t}°C`}}}}}),this._canvas.addEventListener("dblclick",()=>{this._chart?.resetZoom()})}_loadChartJs(){return new Promise((t,e)=>{const i=document.createElement("script");i.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",i.onload=()=>{const i=document.createElement("script");i.src="https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns@3/dist/chartjs-adapter-date-fns.bundle.min.js",i.onload=()=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/chartjs-plugin-annotation@3/dist/chartjs-plugin-annotation.min.js",e.onload=()=>{const e=window;e["chartjs-plugin-annotation"]&&(e.ChartAnnotation=e["chartjs-plugin-annotation"]);const i=document.createElement("script");i.src="https://cdn.jsdelivr.net/npm/chartjs-plugin-zoom@2/dist/chartjs-plugin-zoom.min.js",i.onload=()=>t(),i.onerror=()=>{t()},document.head.appendChild(i)},e.onerror=()=>{t()},document.head.appendChild(e)},i.onerror=()=>e(new Error("Failed to load chart adapter")),document.head.appendChild(i)},i.onerror=()=>e(new Error("Failed to load Chart.js")),document.head.appendChild(i)})}render(){if(!this._config||!this.hass)return D`<ha-card><div>Chargement...</div></ha-card>`;const t=this._getTempEntity(),e=t?vt(t.state):null,i=this._config.title||"Température",s=t?.attributes.unit_of_measurement||"°C",o=this._tempHistory.length>0?Math.min(...this._tempHistory.map(t=>t.y)).toFixed(1):void 0,r=this._tempHistory.length>0?Math.max(...this._tempHistory.map(t=>t.y)).toFixed(1):void 0,n=this._getEntityId("flow_in"),a=n?this.hass.states[n]:void 0,l="on"===a?.state?.toLowerCase();return D`
      <ha-card>
        ...
        <div class="current-value">
          ...
          ${D`<span class="unit">${s}</span>`}
          ${l||null===e?F:D`<span class="min-max" style="color: var(--warning-color, #ff9800)">⚠ Filtration arrêtée</span>`}
          ${void 0!==o&&void 0!==r?D`<span class="min-max">Min: ${o} — Max: ${r}</span>`:F}
        </div>

        ${this._tempHistory.length>0?D`<div class="chart-wrapper"><canvas></canvas></div>`:D`<div class="no-data">${this._loading?"Chargement...":"Aucune donnée"}</div>`}
  ...
  `,t([pt({attribute:!1})],Ht.prototype,"hass",void 0),t([ut()],Ht.prototype,"_config",void 0),t([ut()],Ht.prototype,"_period",void 0),t([ut()],Ht.prototype,"_tempHistory",void 0),t([ut()],Ht.prototype,"_filtrationOffRanges",void 0),t([ut()],Ht.prototype,"_loading",void 0),Ht=t([ct("bayrol-pool-temp-chart-card")],Ht);let Ot=class extends at{setConfig(t){if(!t.device_serial&&!t.entity_id)throw new Error("Configuration requise : 'device_serial' ou 'entity_id'");this._config=t}getCardSize(){return 3}_getEntity(){if(!this.hass||!this._config)return;if(this._config.entity_id)return this.hass.states[this._config.entity_id];const t=this._config.entity_prefix;if(t)return this.hass.states[`sensor.${t}_messages`];const e=mt(this.hass.states,this._config.device_serial,"messages","sensor");return e?this.hass.states[e]:void 0}_getMessages(){const t=this._getEntity();if(!t)return[];const e=t.attributes.data;return e&&Array.isArray(e)?e:[]}_renderMessage(t){const e=t.type||"info";return D`<ha-alert alert-type="${e}">${t.message}</ha-alert>`}render(){if(!this._config||!this.hass)return D`<ha-card><div>Chargement...</div></ha-card>`;const t=this._config.title||"Messages",e=this._getMessages();return D`
      <ha-card>
        <div class="header">
          <span class="title">${t}</span>
          ${e.length>0?D`<span class="count">${e.length}</span>`:F}
        </div>
        ${e.length>0?D`<div class="messages">${e.map(t=>this._renderMessage(t))}</div>`:D`
              <div class="empty">
  ...
  `,t([pt({attribute:!1})],Ot.prototype,"hass",void 0),t([ut()],Ot.prototype,"_config",void 0),Ot=t([ct("bayrol-pool-messages-card")],Ot);let Mt=class extends at{setConfig(t){this._config=t}_valueChanged(t){if(!this._config)return;const e=t.target,i=e.configValue,s={...this._config,[i]:e.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:s}}))}render(){return this._config?D`
      <div style="padding: 16px;">
        <ha-textfield
          label="Titre (optionnel)"
          .value="${this._config.title||""}"
    ...
    `:D``}};t([pt({attribute:!1})],Mt.prototype,"hass",void 0),t([ut()],Mt.prototype,"_config",void 0),Mt=t([ct("bayrol-pool-messages-editor")],Mt);class Tt extends HTMLElement{static getCreateSuggestions(t){return{title:"Bayrol Pool Access",icon:"mdi:pool"}}static async generate(t,e){const i=t.device_serial||function(t){const e=/^sensor\.(.+?)_(\d{5,})_(temperature|ph|mv_se|salt|status)$/;for(const i of Object.keys(t.states)){const t=i.match(e);if(t)return t[2]}}(e)||"",s=t.entity_prefix,o=!1!==t.show_equipment,r=!1!==t.show_charts,n=[{type:"custom:bayrol-pool-dashboard-card",device_serial:i,...s?{entity_prefix:s}:{},show_equipment:o}];!1!==t.show_messages&&n.push({type:"custom:bayrol-pool-messages-card",device_serial:i,...s?{entity_prefix:s}:{}});const a=[{title:"Vue d'ensemble",path:"overview",icon:"mdi:pool",cards:n}];return r&&a.push({title:"Historique",path:"history",icon:"mdi:chart-line",cards:[{type:"custom:bayrol-pool-temp-chart-card",title:"Température",device_serial:i,...s?{entity_prefix:s}:{}},{type:"custom:bayrol-pool-chart-card",title:"pH",device_serial:i,entity_key:"ph",unit:"pH",color:"#ff9800",...s?{entity_prefix:s}:{}},{type:"custom:bayrol-pool-chart-card",title:"ORP",device_serial:i,entity_key:"mv_se",unit:"mV",color:"#4caf50",...s?{entity_prefix:s}:{}}]}),{title:t.title||"Bayrol Pool Access",views:a}}}customElements.define("ll-strategy-dashboard-bayrol-pool",Tt);let Rt=class extends at{constructor(){super(...arguments),this._config={type:"custom:bayrol-pool"}}setConfig(t){this._config=t}_dispatchChanged(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_valueChanged(t){const e=t.target,i=e.configValue;if(!i)return;const s="checkbox"===e.type?e.checked:e.value;this._config={...this._config,[i]:s},this._dispatchChanged()}_switchChanged(t){const e=t.target,i=e.configValue;i&&(this._config={...this._config,[i]:e.checked},this._dispatchChanged())}render(){return D`
      <div>
        <div class="row">
          <ha-textfield
            label="Numéro de série du device"
