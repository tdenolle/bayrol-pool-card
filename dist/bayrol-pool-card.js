...
`;function gt(t){return t.replace(/[\W_]/g,"").toLowerCase()}function mt(t,e,i,s="sensor"){const o=function(t,e,i="sensor"){return`${i}.${gt("Bayrol")}_${gt(t)}_${e}`}(e,i,s);if(t[o])return o;const r=gt(e);for(const e of Object.keys(t))if(e.startsWith(`${s}.`)&&e.includes(r)&&e.endsWith(`_${i}`))return e}function vt(t){if(void 0===t||"unknown"===t||"unavailable"===t)return null;const e=parseFloat(t);return isNaN(e)?null:e}function yt(t,e,i,s,o){return t>=s&&t<=o?"var(--success-color, #4caf50)":t>=e&&t<=i?"var(--warning-color, #ff9800)":"var(--error-color, #f44336)"}function $t(t){return yt(t,6.8,7.8,7,7.4)}function bt(t){return yt(t,550,900,650,750)}const xt=/^sensor\.(.+?)_(\d{5,})_(temperature|ph|mv_se|salt|status)$/;function wt(t){const e=new Map;for(const i of Object.keys(t.states)){const t=i.match(xt);if(t){const i=t[1],s=t[2];e.has(s)||e.set(s,{serial:s,prefix:i,label:`${i} – ${s}`})}}return Array.from(e.values())}class Ct extends HTMLElement{static getCreateSuggestions(t){return{title:"Bayrol Pool Access",icon:"mdi:pool"}}static async generate(t,e){const i=wt(e),s=t.device_serial||(i.length>0?i[0].serial:""),o=t.entity_prefix,r=!1!==t.show_equipment,n=!1!==t.show_charts,a=[{type:"custom:bayrol-pool-dashboard-card",device_serial:s,...o?{entity_prefix:o}:{},show_equipment:r}];!1!==t.show_messages&&a.push({type:"custom:bayrol-pool-messages-card",device_serial:s,...o?{entity_prefix:o}:{}});const l=[{title:"Vue d'ensemble",path:"overview",icon:"mdi:pool",cards:a}];return n&&l.push({title:"Historique",path:"history",icon:"mdi:chart-line",cards:[{type:"custom:bayrol-pool-temp-chart-card",title:"Température",device_serial:s,...o?{entity_prefix:o}:{}},{type:"custom:bayrol-pool-chart-card",title:"pH",device_serial:s,entity_key:"ph",unit:"pH",color:"#ff9800",...o?{entity_prefix:o}:{}},{type:"custom:bayrol-pool-chart-card",title:"ORP",device_serial:s,entity_key:"mv_se",unit:"mV",color:"#4caf50",...o?{entity_prefix:o}:{}}]}),{title:t.title||"Bayrol Pool Access",views:l}}}customElements.define("ll-strategy-dashboard-bayrol-pool",Ct);const At=[{key:"temperature",label:"Température",icon:"mdi:thermometer-water",unit:"°C"},{key:"ph",label:"pH",icon:"mdi:ph",unit:"pH",color_fn:$t},{key:"mv_se",label:"ORP",icon:"mdi:water-opacity",unit:"mV",color_fn:bt},{key:"salt",label:"Sel",icon:"mdi:shaker-outline",unit:"g/L"}],Et=[{key:"se_on_off",label:"Électrolyse",domain:"switch"},{key:"ph_on_off",label:"Régulation pH",domain:"switch"},{key:"mv_on_off",label:"Régulation ORP",domain:"switch"},{key:"se_activate_boost",label:"Boost",domain:"switch"},{key:"filtration_mode",label:"Filtration",domain:"select"}];let St=class extends at{setConfig(t){if(!t.device_serial)throw new Error("Configuration requise : 'device_serial'");this._config={show_equipment:!0,...t}}getCardSize(){return this._config?.show_equipment?5:3}_getEntity(t,e="sensor"){if(!this.hass||!this._config)return;const i=this._config.entities;if(i&&i[t])return this.hass.states[i[t]];const s=this._config.entity_prefix;if(s)return this.hass.states[`${e}.${s}_${t}`];const o=mt(this.hass.states,this._config.device_serial,t,e);return o?this.hass.states[o]:void 0}_isOnline(){const t=this._getEntity("status");return!!t&&"Online"===t.state}_renderMetric(t){const e=this._getEntity(t.key,t.domain||"sensor"),i=e?vt(e.state):null,s=null!==i,o=s?i.toString():"--",r=s&&t.color_fn?t.color_fn(i):"var(--pool-text)",n=e?.attributes.min,a=e?.attributes.max,l=void 0!==n&&void 0!==a?`${n} — ${a}`:"";return B`
      ...
      <ha-card>
        ...
        ${this._config.show_equipment?B`
              <div class="equipment">
                ...
                <div class="eq-grid">
                  ${Et.map(t=>this._renderEquipmentItem(t))}
                </div>
              </div>
            `:F}
      </ha-card>
    `}static getConfigElement(){return document.createElement("bayrol-pool-dashboard-editor")}static getStubConfig(){return{device_serial:"",show_equipment:!0}}};St.styles=ft,t([pt({attribute:!1})],St.prototype,"hass",void 0),t([ut()],St.prototype,"_config",void 0),St=t([ct("bayrol-pool-dashboard-card")],St);let kt=class extends at{constructor(){super(...arguments),this._devices=[],this._manualSerial=!1}setConfig(t){this._config=t,this._refreshDevices()}updated(t){t.has("hass")&&this._refreshDevices()}_refreshDevices(){this.hass&&(this._devices=wt(this.hass),this._config?.device_serial&&!this._devices.some(t=>t.serial===this._config.device_serial)&&(this._manualSerial=!0))}_dispatchChanged(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t}}))}_deviceSelected(t){if(!this._config)return;const e=t.target.value;if("__manual__"===e)return void(this._manualSerial=!0);this._manualSerial=!1;const i={...this._config,device_serial:e};this._dispatchChanged(i)}_valueChanged(t){if(!this._config)return;const e=t.target,i=e.configValue,s="checkbox"===e.type?e.checked:e.value,o={...this._config,[i]:s};this._dispatchChanged(o)}render(){if(!this._config)return B``;const t=this._config.device_serial||"",e=this._devices.length>0;return B`
      <div style="padding: 16px;">
        ...
        ${e?B`
              ...
              >
                ${this._devices.map(t=>B`<ha-list-item .value="${t.serial}">${t.label}</ha-list-item>`)}
                <ha-list-item value="__manual__">Saisie manuelle…</ha-list-item>
              </ha-select>
              ${this._manualSerial?B`
                    <ha-textfield
    ...
    `}static getConfigElement(){return document.createElement("bayrol-pool-chart-editor")}static getStubConfig(){return{device_serial:"",entity_key:"temperature",hours_to_show:24}}};Ht.styles=_t,t([pt({attribute:!1})],Ht.prototype,"hass",void 0),t([ut()],Ht.prototype,"_config",void 0),t([ut()],Ht.prototype,"_period",void 0),t([ut()],Ht.prototype,"_history",void 0),t([ut()],Ht.prototype,"_loading",void 0),Ht=t([ct("bayrol-pool-chart-card")],Ht);let Ot=class extends at{setConfig(t){this._config=t}_valueChanged(t){if(!this._config)return;const e=t.target,i=e.configValue,s={...this._config,[i]:e.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:s}}))}render(){return this._config?B`
      <div style="padding: 16px;">
        <ha-textfield
          label="Titre (optionnel)"
          .value="${this._config.title||""}"
    ...
    `}static getStubConfig(){return{device_serial:"",title:"Température"}}};Tt.styles=n`
    :host {
      --pool-text: var(--primary-text-color, #212121);
      --pool-text-secondary: var(--secondary-text-color, #727272);
    }
  ...
  `,t([pt({attribute:!1})],Tt.prototype,"hass",void 0),t([ut()],Tt.prototype,"_config",void 0),t([ut()],Tt.prototype,"_period",void 0),t([ut()],Tt.prototype,"_tempHistory",void 0),t([ut()],Tt.prototype,"_filtrationOffRanges",void 0),t([ut()],Tt.prototype,"_loading",void 0),Tt=t([ct("bayrol-pool-temp-chart-card")],Tt);let Rt=class extends at{setConfig(t){if(!t.device_serial&&!t.entity_id)throw new Error("Configuration requise : 'device_serial' ou 'entity_id'");this._config=t}getCardSize(){return 3}_getEntity(){if(!this.hass||!this._config)return;if(this._config.entity_id)return this.hass.states[this._config.entity_id];const t=this._config.entity_prefix;if(t)return this.hass.states[`sensor.${t}_messages`];const e=mt(this.hass.states,this._config.device_serial,"messages","sensor");return e?this.hass.states[e]:void 0}_getMessages(){const t=this._getEntity();if(!t)return[];const e=t.attributes.data;return e&&Array.isArray(e)?e:[]}_renderMessage(t){const e=t.type||"info";return B`<ha-alert alert-type="${e}">${t.message}</ha-alert>`}render(){if(!this._config||!this.hass)return B`<ha-card><div>Chargement...</div></ha-card>`;const t=this._config.title||"Messages",e=this._getMessages();return B`
    ...
    `}static getConfigElement(){return document.createElement("bayrol-pool-messages-editor")}static getStubConfig(){return{device_serial:""}}};Rt.styles=n`
    :host {
      --pool-text: var(--primary-text-color, #212121);
      --pool-text-secondary: var(--secondary-text-color, #727272);
    }
  ...
  `,t([pt({attribute:!1})],Rt.prototype,"hass",void 0),t([ut()],Rt.prototype,"_config",void 0),Rt=t([ct("bayrol-pool-messages-card")],Rt);let qt=class extends at{setConfig(t){this._config=t}_valueChanged(t){if(!this._config)return;const e=t.target,i=e.configValue,s={...this._config,[i]:e.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:s}}))}render(){return this._config?B`
      <div style="padding: 16px;">
        <ha-textfield
          label="Titre (optionnel)"
          .value="${this._config.title||""}"
    ...
    `:B``}};t([pt({attribute:!1})],qt.prototype,"hass",void 0),t([ut()],qt.prototype,"_config",void 0),qt=t([ct("bayrol-pool-messages-editor")],qt);let jt=class extends at{constructor(){super(...arguments),this._config={type:"custom:bayrol-pool"},this._devices=[],this._manualSerial=!1}setConfig(t){this._config=t,this._refreshDevices()}updated(t){t.has("hass")&&this._refreshDevices()}_refreshDevices(){this.hass&&(this._devices=wt(this.hass),this._config.device_serial&&!this._devices.some(t=>t.serial===this._config.device_serial)&&(this._manualSerial=!0))}_dispatchChanged(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_deviceSelected(t){const e=t.target.value;"__manual__"!==e?(this._manualSerial=!1,this._config={...this._config,device_serial:e},this._dispatchChanged()):this._manualSerial=!0}_valueChanged(t){const e=t.target,i=e.configValue;if(!i)return;const s="checkbox"===e.type?e.checked:e.value;this._config={...this._config,[i]:s},this._dispatchChanged()}_switchChanged(t){const e=t.target,i=e.configValue;i&&(this._config={...this._config,[i]:e.checked},this._dispatchChanged())}_renderDevicePicker(){const t=this._config.device_serial||"";return 0===this._devices.length?B`
        <div class="row">
          <ha-textfield
            label="Numéro de série du device"
            .value="${t}"
